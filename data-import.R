...
# Replace NAs with 0s for relevant variables (semesters on payment plan, MEP bootcamp, SI count)
students$percent_semesters_with_payment_plan[is.na(students$percent_semesters_with_payment_plan)] <- 0
students$mep_academic_boot_camp[is.na(students$mep_academic_boot_camp)] <- FALSE
students$si_count[is.na(students$si_count)] <- 0
students$summer_start_flag[is.na(students$summer_start_flag)] <- FALSE
